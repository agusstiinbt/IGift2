namespace IGift.Infrastructure.MongoDb.Services.cs.Models
{
    ...
    public class ChatService2 : IChatService2
    {
        private readonly INonAuditableMongoDbUnitOfWork<string, ChatHistory> _unitOfWork;

        public ChatService2(INonAuditableMongoDbUnitOfWork<string, ChatHistory> unitOfWork)
        {
